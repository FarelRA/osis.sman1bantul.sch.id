<?php
$title = 'Blogs - OSIS SMAN 1 Bantul';
...
<section class="py-20">
    <div class="container mx-auto px-4">
        <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold text-center mb-4 text-gray-900 dark:text-white">Blog &
            Articles</h1>
        <p class="text-center text-gray-600 dark:text-gray-400 mb-12 max-w-2xl mx-auto text-lg">
            Tips, informasi, dan cerita dari OSIS SMAN 1 Bantul
        </p>
                ...
                <a href="/blog/<?= $blog['slug'] ?>"
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <span
                                class="badge bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300"><?= htmlspecialchars($blog['category']) ?></span>
                            <span
                                class="text-gray-600 dark:text-gray-400"><?= date('M j, Y', strtotime($blog['date'])) ?></span>
                        </div>
                    </div>
                </a>
            <?php endforeach; ?>
